...
class DataDescriptor(CardinalityFreeDataDescriptor,
  ...
  @staticmethod
  def create(arg_uris: List[str], arg_type: computation_types.Type):
    """Construct a `DataDescriptor` instance targeting a `tff.DataBackend`.
    ...
    return DataDescriptor(
        None, args, computation_types.FederatedType(arg_type,
                                                    placements.CLIENTS),
        len(args))
